...
{
	std::cout << "Default constructor called for FormNotSignedException" << std::endl;
}

Form::FormNotSignedException::FormNotSignedException(const FormNotSignedException &other)
{
	std::cout << "Copy constructor called for FormNotSignedException" << std::endl;
	*this = other;
}

Form::FormNotSignedException &Form::FormNotSignedException::operator=(const FormNotSignedException &other)
{
	(void)other;
	std::cout << "Assignation constructor called for FormNotSignedException" << std::endl;
	return (*this);
}

Form::FormNotSignedException::~FormNotSignedException() throw()
{
	std::cout << "Destructor of FormNotSignedException called" << std::endl;
}
